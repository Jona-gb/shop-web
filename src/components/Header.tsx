      ...
      <div className="relative mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center justify-end gap-3">
          ...
          {user ? (
            ...
            <Link to="/login" className="hidden h-10 items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 text-xs font-semibold text-white/75 transition hover:bg-white/10 hover:text-white sm:inline-flex">
