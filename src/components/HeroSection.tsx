      ...
      <div className="shop-container py-6">
        <div className="relative grid min-h-[520px] items-center overflow-hidden rounded-[2rem] border border-border bg-card px-5 py-10 shadow-[0_28px_70px_rgba(15,23,42,0.08)] sm:px-8 md:grid-cols-[0.86fr_1.14fr] md:py-0 lg:px-14">
          ...
          <div className="z-10 flex max-w-xl flex-col items-start gap-5">
            ...
            <h1 className="font-display text-4xl font-semibold leading-[1.03] text-foreground sm:text-6xl">
              {headline}
              {highlightedText && (
                <>
                  <br />
            ...
            <p className="max-w-sm text-lg font-medium leading-7 text-muted-foreground">{description}</p>
            <p className="rounded-full border border-border bg-card px-4 py-2 text-xs font-semibold text-muted-foreground">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <Link
                to={secondaryCtaLink}
                className="inline-flex h-11 items-center justify-center rounded-full px-1 text-sm font-semibold text-foreground transition hover:text-primary"
              >
                {secondaryCtaText}
              </Link>
            </div>
